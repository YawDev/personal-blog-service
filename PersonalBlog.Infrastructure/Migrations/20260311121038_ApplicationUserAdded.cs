    ...
    public partial class ApplicationUserAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("blog_users_pkey", x => x.id);
                    table.ForeignKey(
                        name: "FK_blog_users_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    content = table.Column<string>(type: "text", nullable: false),
                    preview = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    dateposted = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    userid = table.Column<Guid>(type: "uuid", nullable: false),
                    createddate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    lastmodifieddate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP")
                },
            ...
            migrationBuilder.CreateIndex(
                name: "blog_users_email_key",
                table: "blog_users",
                column: "email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "blog_users_username_key",
                table: "blog_users",
                column: "username",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_blog_users_IdentityUserId",
                table: "blog_users",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "idx_drafts_created_on",
                table: "drafts",
                column: "createdon",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "idx_drafts_title",
                table: "drafts",
                column: "title");

            migrationBuilder.CreateIndex(
                name: "idx_drafts_user",
                table: "drafts",
                column: "userid");
